"""
Django settings for quiet_rain_dev_63957 project.
...
ROOT_URLCONF = 'quiet_rain_dev_63957.urls'
...
WSGI_APPLICATION = 'quiet_rain_dev_63957.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "quiet_rain_dev_63957 API",
    "DESCRIPTION": "API documentation for quiet_rain_dev_63957 App",
    "VERSION": "v1",
}
